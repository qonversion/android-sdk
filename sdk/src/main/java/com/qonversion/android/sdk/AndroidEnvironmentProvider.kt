...
class AndroidEnvironmentProvider(private val context: Context): EnvironmentProvider {

    companion object {
        private const val UNKNOWN = "UNKNOWN"
    }

    override fun getInfo(internalUserId: String, ads: AdsDto): Environment = Environment(internalUserId, getAppInfo(), getDeviceInfo(ads))
