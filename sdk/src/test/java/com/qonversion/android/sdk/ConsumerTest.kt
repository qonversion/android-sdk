...
class ConsumerTest {
    ...
    @Test
    fun `consume purchase history records when observe mode is true`(){
    ...
    @Test
    fun `consume purchase history records for inapp`(){
        val record = mockPurchaseHistoryRecord()
        val purchaseHistory = PurchaseHistory(skuTypeInApp, record)
        val purchaseHistoryList = listOf(purchaseHistory)
    ...
    @Test
    fun `consume purchase history records for subs`(){
        val record = mockPurchaseHistoryRecord()
