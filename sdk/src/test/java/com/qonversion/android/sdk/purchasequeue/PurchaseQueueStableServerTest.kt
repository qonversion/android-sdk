...
class PurchaseQueueStableServerTest {
    ...
    fun setup() {
        ...
        val client = Util.getMockHttpClient(StableServerSimulation())
    ...
    fun sendOnlyUniquePurchases() {
        ...
        Assert.assertEquals(uniquePurchaseCount + uniqueSubscriptionCount, purchaseDataSource.count())
    }
    ...
    fun sendSingleSamePurchaseManyTime() {
        ...
        subscriber.assertNoErrors()
        Assert.assertEquals(1, purchaseDataSource.count())
    }
    ...
    fun sendManySamePurchasesManyTime() {
        ...
        while (i != 10) {
            ...
            purchaseSendingQueue.addPurchase(Util.purchaseWithName("purchase_3"))
            purchaseSendingQueue.addPurchase(Util.purchaseWithName("purchase_4"))
            purchaseSendingQueue.addPurchase(Util.purchaseWithName("purchase_5"))
            i++
        }
        subscriber.assertNoErrors()
        Assert.assertEquals(5, purchaseDataSource.count())
    }
