...
import io.qonversion.android.sdk.dto.entitlements.QEntitlementsCacheLifetime
import io.qonversion.android.sdk.internal.application
...
import io.qonversion.android.sdk.internal.isDebuggable
...
internal class QonversionConfigTest {
    ...
    inner class BuildMethodTest {
        ...
        @BeforeEach
        fun setUp() {
            mockkStatic("io.qonversion.android.sdk.internal.ExtensionsKt")
        ...
        @AfterEach
        fun after() {
            unmockkStatic("io.qonversion.android.sdk.internal.ExtensionsKt")
        }
    }
